...
class Matrix3:
    ...
    def multiply_with_scalar(self, scalar: float) -> 'Matrix3':
    ...
    def sumup(self, other: 'Matrix3') -> None: # aufsummierung (self wird übergeschrieben)
        self.x_0 += other.x_0 
        self.y_0 += other.y_0
        self.z_0 += other.z_0
        self.x_1 += other.x_1 
